...
quote_page = ['http://www.songlyrics.com/prince/18-over-lyrics/',
              ...
              'http://www.songlyrics.com/prince/dig-u-better-dead-lyrics/',
              ...
              'http://www.songlyrics.com/prince/ice-cream-castles-lyrics/',
...
with open('index.csv', 'a') as csv_file:
    ...
    for name, song in data:
        writer.writerow([song, datetime.now()])
